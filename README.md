...
See [`docs/PRIMENET.md`](docs/PRIMENET.md) and [`notebooks/primenet_mimic_iv_colab.ipynb`](notebooks/primenet_mimic_iv_colab.ipynb) for MIMIC-IV NF / mimicall finetune on Colab (upload or URL; no Drive).
